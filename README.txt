...
This code provides a whole environment to train and test a deep reinforcement learning agent that plays Connect4. It is suited for python 3.6 and requires the following modules : Tensorflow, Keras, graphviz, pydot ; all of which can be downloaded with pip or conda. 
